...
p_NPD_GWAS_signif_SNPs_ranking_in_meanCT = p_NPD_GWAS_signif_SNPs_ranking_in_meanCT + ylab("CT %")
...
p_NPD_GWAS_signif_SNPs_ranking_in_totalSA = p_NPD_GWAS_signif_SNPs_ranking_in_totalSA + ylab("SA %")
